  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        >
          <span className="font-serif text-lg md:text-2xl text-theme-charcoal tracking-widest group-hover:text-theme-terracotta transition-colors duration-300 font-bold">
            近物レックス
          </span>
        ...
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-8 mr-4">
            {navItems.map((item) => (
              <button
                ...
                className="text-sm font-serif text-theme-charcoal hover:text-theme-terracotta transition-colors duration-300 relative group font-medium"
              >
                {item.label}
          ...
          <a 
            href="https://www.google.com/maps/search/?api=1&query=愛知県小牧市堀の内4丁目136-1"
            target="_blank"
            rel="noopener noreferrer"
